                            ...
                            <div class="container py-5">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${cartDetails}" var="cd" varStatus="status">
                                                <tr>
                                                    <th scope="row">
                                                    ...
                                                    <td>
                                                        <p class="mb-0 mt-4">
                                                            <fmt:formatNumber type="number" value="${cd.price}" />
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <div class="input-group quantity mt-4" style="width: 100px;">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="${cd.quantity}" data-cart-detail-id="${cd.id}"
                                                    ...
                                                    <td>
                                                        <p class="mb-0 mt-4" data-cart-detail-id="${cd.id}">
                                                            <fmt:formatNumber type="number"
                                                                value="${cd.price * cd.quantity}" />
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <form method="post" action="/delete-cart-item/${cd.id}">
                                                            <button type="submit"
