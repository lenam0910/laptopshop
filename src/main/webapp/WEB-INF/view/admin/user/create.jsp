        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/user">Danh sách người dùng</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            ...
                            <form:form method="post" action="/admin/user/create"
                                       modelAttribute="newUser" cssClass="container-fluid"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <form:input type="text" cssClass="form-control"
                                                    cssErrorClass="form-control is-invalid" path="phone"/>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <form:input type="text" cssClass="form-control"
                                                    cssErrorClass="form-control is-invalid" path="address"/>
